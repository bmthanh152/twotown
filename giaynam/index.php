...
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" content-type="text/css">
...
<body>
    <div id="app">
        ...
        <!--End header section-->
        <section id="body">
            <div class="body-gnam  content-width">
                <div class="boyd-lh--link content-width" style="margin: 30px 0px;">
                        <h2 style="color: var(--color-text-black); font-size:2.3rem"><span><a style="color: var(--color-text-black);" href="../index.php">Trang chủ</a></span> / <a style="color: var(--color-text-black);" href="./index.php">Giày Nam</a></h2>
                </div>
            </div>
            <div class="body-gnam--containbox content-width">
                <div class="body-gnam--filter">
                    ...
                    <a href="../info-product.php?id=06"><div class="body-gnam-banner--ads"></div></a>
                    <a href="../info-product.php?id=10"><div class="body-banner--ads"></div></a>
                </div>
                <div class="body-gnam--productContain">
                    <!-----------------PRODUCT CARD--------------------->
                        ...
                        <?php
                                ...
                                $sql = "SELECT *, FORMAT (Cost,'#.###.###') AS price FROM brand_info where `Gender-style` = 'Nam'";
                     ...
                     <div class="footer-content--info">
                        <div class="footer-content-col">
                            ...
                            <ul class="footer-content-col--list">
                                ...
                                <li><a href="./index.php">Giày Nữ</a></li>
                            </ul>
                        </div>
                        <div class="footer-content-col">
                            <h3>Công ty</h3>
