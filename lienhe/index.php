...
<body>
    <div id="app">
        ...
        <!--Start body section--->
        <section id="body">
            <div class="body-lh content-width">
                <div class="boyd-lh--link" style="margin: 30px 0px;">
                    <h2 style="color: var(--color-text-black);"><span><a style="color: var(--color-text-black);" href="../index.php">Trang chủ</a></span> / <a style="color: var(--color-text-black);" href="./index.php"> Liên Hệ</a></h2>
                </div>
                <div class="body-lh-title">
                    <center><h1 style="color: var(--logo-color); font-weight: bold; font-size: 3rem;">Shop giày TwoTown.</h1></center>
                </div>
                <div class="body-lh--map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d313.0424698042649!2d106.7632833684072!3d10.857395032367746!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317527cfe0d0b7b3%3A0x70ce0edc5e2070d4!2sTwoTown!5e0!3m2!1svi!2s!4v1681847528722!5m2!1svi!2s"  width="600" height="550" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <div class="body-lh--contact">
                    <div class="body-lh--contact-icon">
                        <i class="fa-solid fa-location-dot"></i>
                        <h2>Địa chỉ:</h2>
                        <a href="https://goo.gl/maps/nATt9eRev5ryQkf88">Hoàng Diệu 2, Thủ Đức, TP.Hồ Chí Minh</a>
                    </div> 
                    <div class="body-lh--contact-icon">
                    ...
                    <div class="body-lh--contact-icon">
                        ...
                        <h2>Email:</h2>
                        <a href="">twotown.online@gmail.com</a>
                    </div>
                </div>
                <div class="body-lh-formContact content-width">
                    <form target="_blank" action="https://script.google.com/macros/s/AKfycbzKzd6jkyP2BI-VR5bCLewYFlrPUlmiXDXiDzuJa5KGdOLygHEdBhVnFoWwC7PuJyWblA/exec" method="POST">
                        <fieldset>
                            ...
                            <textarea name="textarea-noidung" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required form_lien_he" id="textarea-noidung" aria-required="true" aria-invalid="false" placeholder="Lời nhắn" style="width: 89%; height: 137px; margin: 1% 0%;padding: 1%;
